...
public class RecentlyWatchedCasesActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recently_watched_cases);
        ...
        ListView rcmndList= (ListView) findViewById(R.id.listView3);
        ...
        rcmndList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(RecentlyWatchedCasesActivity.this, ShowCaseActivity.class);
                startActivity(i);
            }
        });
    }
